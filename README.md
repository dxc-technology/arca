...
| Suite | Tests | Details |
|-------|------:|---------|
| Unit tests (Rust) | 845 | arca-auth: 39, arca-core: 241, arca-proto: 44, arca-server: 264, arca-storage: 257 |
...
| **Arca tests** | **1,530** | **All tests written for this project** |
