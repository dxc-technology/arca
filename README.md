...
| Suite | Tests | Details |
|-------|------:|---------|
| Unit tests (Rust) | 874 | arca-auth: 39, arca-core: 245, arca-proto: 61, arca-server: 269, arca-storage: 260 |
...
| **Arca tests** | **1,570** | **All tests written for this project** |
