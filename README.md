...
| Suite | Tests | Details |
|-------|------:|---------|
| Unit tests (Rust) | 859 | arca-auth: 39, arca-core: 245, arca-proto: 46, arca-server: 269, arca-storage: 260 |
...
| **Arca tests** | **1,547** | **All tests written for this project** |
