...
4. Fill in:
   ...
   - **Tag filter** (optional): click **+ Tag** to require one or more `key=value` tags. An object must carry **all** listed tags to match. Combine with prefix to narrow further — both conditions must hold.
